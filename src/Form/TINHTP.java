 ...
 * @author Acer
 */
public class TINHTP extends javax.swing.JFrame {

    /**
     * Creates new form TINHTP
     */
...
public void Loadulieu() {
        ...
        try {
            tbl_tinhtp.removeAll();
            String[] arr = {"Mã tỉnh", "Tên tỉnh"};
            tbtModel = new DefaultTableModel(arr, 0);
            String sql = "SELECT * FROM TinhTP";
            ...
            {
                    rs.getString("MaTinh"), rs.getString("TenTinh")};
                
                tbtModel.addRow(row);
            }
            tbl_tinhtp.setModel(tbtModel);
    ...
    private void initComponents() {
        ...
        tbl_tinhtp = new javax.swing.JTable();
        ...
        setTitle("Quản lý tỉnh");

        lblDong2.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblDong2.setText("Mã tỉnh:");

        lblDong3.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lblDong3.setText("Tên tỉnh:");

        tbl_tinhtp.setFont(new java.awt.Font("Segoe UI", 0, 15)); // NOI18N
        tbl_tinhtp.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        jScrollPane1.setViewportView(tbl_tinhtp);

        txtMaTinh.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/tinhtp.png"))); // NOI18N
        jLabel1.setText("QUẢN LÝ TỈNH TP");

        txtTenTinh.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtMaTinh, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(lblDong3, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtTenTinh, javax.swing.GroupLayout.PREFERRED_SIZE, 224, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(18, 18, 18)
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (txtMaTinh.getText().equals(""))
        {
            sb.append("MaTinh đang trống!\n");
            txtMaTinh.requestFocus();
        }
        if (sb.length() > 0)
        {
        ...
        try
        {
            TinhTP TTP = new TinhTP();
            TINHTPDAO TinhTPup = new  TINHTPDAO();

            TTP.setMaTinh(txtMaTinh.getText());
            TTP.setTenTinh(txtTenTinh.getText());
    ...
    private void btnxoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnxoaActionPerformed
        ...
        int dk = JOptionPane.showConfirmDialog(this, "Bạn muốn xóa tinhtp này", "Thông báo", JOptionPane.YES_NO_OPTION);
        if (dk == JOptionPane.YES_OPTION) {
            try {
                TINHTPDAO k = new TINHTPDAO();
                if (k.Delete(txtMaTinh.getText())) {
                    JOptionPane.showMessageDialog(this, "Xóa tinhtp thành công");
                } else {
                    JOptionPane.showMessageDialog(this, "Xóa tinhtp thất bại");
                }
                Loadulieu();
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "Error: " + e.getMessage());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            TinhTP k = new TinhTP();
            TINHTPDAO kd = new TINHTPDAO();

            k.setMaTinh(txtMaTinh.getText());
            k.setTenTinh((txtTenTinh.getText()));

            kd.insert(k);
            Loadulieu();
            JOptionPane.showMessageDialog(this, "Thêm tinhtp thành công!");

        } catch (Exception e) {

            JOptionPane.showMessageDialog(this, "Không thể thêm tinhtp!");
            JOptionPane.showMessageDialog(this, "Error: " + e.getMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TINHTP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable tbl_tinhtp;
